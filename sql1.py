...
final_df.to_sql('data', conn, if_exists='replace')
cardio_df.to_sql('cardio', conn, if_exists='replace')
diabetes_df.to_sql('deiabetes', conn, if_exists='replace')
lung_df.to_sql('lungs', conn, if_exists='replace')
